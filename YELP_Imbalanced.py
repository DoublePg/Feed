...
import time
from data_utils import load_YELP_data, generate_YELP_business_based_data, get_index
...
if __name__ == "__main__":
    ...
    with open(conf_file, "r") as f:
        ...
        model_path = conf_dict["model_path"]
    ...
    print("=" * 60)
    private_data, private_test_locdata, total_private_data = generate_YELP_business_based_data(private_dataset_train,
                                                                                               N_parties, word_index,
                                                                                               max_sequence_length,
                                                                                               read_saved=True)
    ...
    if method == 'Ditto':
        ditto = Ditto(parties,
                      ...
                      private_test_localdata=private_test_locdata,
        ...
        fedprox = FedProx(parties,
                          ...
                          dataset=dataset_name)
        start_time = time.time()
        collaboration_performance1 = fedprox.collaborative_training()
        ...
        fedrep = FedRep(parties,
                        ...
                        private_test_localdata=private_test_locdata,
                        dataset=dataset_name)
        collaboration_performance1 = fedrep.collaborative_training()
