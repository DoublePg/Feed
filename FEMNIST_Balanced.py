...
def parseArg():
    ...
    parser.add_argument('--conf', type=str, default="conf/FEMNIST_balanced_conf.json",
...
if __name__ == "__main__":
    ...
    conf_file_mmoe, method = parseArg()
    with open(conf_file_mmoe, "r") as f:
    ...
    if method == 'Ditto':
        ...
        collaboration_performance1 = fedphp.collaborative_training()
