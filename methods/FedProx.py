...
from losses import fedprox_loss
    ...
    def collaborative_training(self):
        ...
        while True:
            ...
            for index, d in enumerate(self.collaborative_parties):
                ...
                ploss = fedprox_loss(self.mu, d["model_classifier"].trainable_weights)
                d["model_classifier"].compile(optimizer=tf.keras.optimizers.Adam(lr=1e-3),
                                              loss=lambda y_true, y_pred: ploss(y_true, y_pred, d[
                ...
                d["model_classifier"].fit(self.private_data[index]["X"],
                                          ...
                                          shuffle=True, verbose=0)
                print('private data train loss: ', d["model_classifier"].history.history)
