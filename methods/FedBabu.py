...
class FedBabu():
    def __init__(self,
        ...
        for i in range(self.N_parties):
            ...
            model_A_twin = clone_model(parties[0])
            model_A_twin.set_weights(parties[0].get_weights())
            model_A_twin.get_layer(name="fc1").trainable = False
        ...
        while True:
            ...
            for index, d in enumerate(self.collaborative_parties):
                ...
                if r == self.N_rounds:
                    ...
                    ep = self.N_private_training_round*3
                else:
                    ep = self.N_private_training_round
